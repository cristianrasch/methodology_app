...
describe Project do
  ...
  it "should return an Array of all Projects with documents" do
    Factory(:project)
    doc1 = Factory(:document)
    event = doc1.event
    doc2 = Factory(:document, Factory.attributes_for(:document).merge(:event => event))
    
    projects = Project.library
    projects.should have(1).project
    projects.first.should == event.project
    event.documents.should have(2).documents
    event.documents.first.should == doc2
    event.documents.last.should == doc1
  end
end
